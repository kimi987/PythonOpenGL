...
class GraphicsEngine:
    ...
    def create_framebuffer(self):
        ...
        for i in range(2):
            ...
            self.depthStencialBuffers.append(glGenRenderbuffers(1))
            glBindRenderbuffer(GL_RENDERBUFFER, self.depthStencialBuffers[i])
            glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, SCREEN_WIDTH, SCREEN_HEIGHT)
            glBindRenderbuffer(GL_RENDERBUFFER, 0)
            glFramebufferRenderbuffer(GL_FRAMEBUFFER, GL_DEPTH_STENCIL_ATTACHMENT, GL_RENDERBUFFER, self.depthStencialBuffers[i])
    ...
    def destroy(self):
        ...
        glDeleteRenderbuffers(len(self.depthStencialBuffers), self.depthStencialBuffers)
