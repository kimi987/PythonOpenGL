...
ADVANCED_MATERIAL_FILENAMES = {
    WOOD_MATERIAL: "../Assets/gfx/wood",
    MEDKIT_MATERIAL: "../Assets/gfx/medkit",
    CLAYBRICK_MATERIAL: "../Assets/gfx/ClayBrick",
    HOTEL_WALL_MATERIAL: "../Assets/gfx/FancyHotelWallDirty",
    GLASS_WALL_MATERIAL: "../Assets/gfx/GlassBottleWindow",
    PLASTER_MATERIAL: "../Assets/gfx/LatheAndPlasterWall",
    MARBLE_BRASS_MATERIAL: "../Assets/gfx/MarbleAndBrassDarkSymmetry",
    MARBLE_COLD_MATERIAL: "../Assets/gfx/MarbleAndGoldTriangularTiles"
}

SIMPLE_MATERIAL_FILENAMES = {
    LIGHT_MATERIAL: "../Assets/gfx/greenlight"
}
...
class GraphicsEngine:
    ...
    def load_image_layers(self, material_collection, suffix, layer_count):
        ...
        glTexStorage3D(GL_TEXTURE_2D_ARRAY, 1, GL_RGBA8, MATERIAL_SIZE, MATERIAL_SIZE, layer_count)
