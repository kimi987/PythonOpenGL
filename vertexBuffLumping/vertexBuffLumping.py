...
FULL_ATTRIBUTE_FILENAMES = {
    CUBE_MESH: "../Assets/models/cube.obj",
    CONTAINER_MESH: "../Assets/models/container.obj",
...
SIMPLE_MATERIAL_FILENAMES = {
    LIGHT_MATERIAL: "../Assets/gfx/greenlight.png"
}
...
class GraphicsEngine:
    ...
    def render_scene_objects(self, scene, mirror = None):
        ...
        for obj in scene.lit_objects:
            ...
            glDrawArrays(GL_TRIANGLES, self.offsets[FULL_ATTRIBUTES][obj.mesh_type][0] , self.offsets[FULL_ATTRIBUTES][obj.mesh_type][1])
        ...
        if mirror is not None:
            ...
            glDrawArrays(GL_TRIANGLES, self.offsets[FULL_ATTRIBUTES][scene.player.mesh_type][0] , self.offsets[FULL_ATTRIBUTES][scene.player.mesh_type][1])
            pass
        #unlit shader
        glUseProgram(self.unlit_shader)
        ...
        if mirror is None:
            ...
            for mirror in scene.mirrors:
                ...
                glDrawArrays(GL_TRIANGLES, self.offsets[FULL_ATTRIBUTES][mirror.mesh_type][0], self.offsets[FULL_ATTRIBUTES][mirror.mesh_type][1])
                pass
            for obj in scene.unlit_objects:
                self.materials[obj.material_type].use()
                glUniform3fv(self.tintLoc["unlit"], 1, obj.color)
